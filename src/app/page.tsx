  ...
  return (
    <div className="space-y-8">
      ...
      <div className="pt-8">
        ...
        <p className="text-text-muted mt-2">{t("langLabDesc")}</p>
      </div>
      ...
      <div data-guide="stats" className="grid grid-cols-2 gap-4">
        <Link
          ...
          className="bg-bg-card border border-border rounded-xl p-6 hover:border-border-light transition-colors text-center"
        >
          <div className="text-primary text-sm font-medium">English</div>
        ...
        <Link
          ...
          className="bg-bg-card border border-border rounded-xl p-6 hover:border-border-light transition-colors text-center"
        >
          <div className="text-primary text-sm font-medium">日本語</div>
      ...
      <div data-guide="quick-actions" className="grid grid-cols-2 gap-4">
        <Link
          href="/review"
          className="bg-primary hover:bg-primary-hover text-primary-text rounded-xl p-5 text-center transition-colors"
        >
        ...
        <Link
          href="/add"
          className="bg-bg-input hover:bg-bg-hover text-text rounded-xl p-5 text-center transition-colors"
        >
            ...
            {recent.map((s) => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-text-muted">{s.study_date}</span>
                  {s.title && <span className="text-sm text-text-secondary">{s.title}</span>}
                </div>
                {s.vocabulary && (
                  <p className="text-text-faint text-sm mt-1 truncate">{s.vocabulary.slice(0, 100)}</p>
                )}
              </Link>
            ))}
          </div>
